...
const versions = ['current', 'pending'];
function run() {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const response = yield fetchSubgraphMetrics(subgraphName, version);
            ...
            const output = {
                hasError: false,
                chainHeadBlock: ((_a = chains[0].chainHeadBlock) === null || _a === void 0 ? void 0 : _a.number) || null,
                latestBlock: ((_b = chains[0].latestBlock) === null || _b === void 0 ? void 0 : _b.number) || null
            };
            setOutputs(output);
        }
        catch (error) {
...
function setFailedOutput(output) {
    core.setFailed(`${output.errorCode}: ${output.message}`);
}
function assertVersion(version) {
    if (!versions.includes(version)) {
        throw new Error(`Invalid input argument "version". Supported values: ${versions.join(', ')}.`);
    }
}
function assertFailOnError(value) {
    if (typeof value !== 'boolean') {
        throw new Error(`Invalid input argument "fail_on_error". Supported values: true or false.`);
    }
}
function getGqlQueryName(version) {
    return {
        current: 'indexingStatusForCurrentVersion',
        pending: 'indexingStatusForPendingVersion'
    }[version];
}
function fetchSubgraphMetrics(subgraphName, version) {
    return __awaiter(this, void 0, void 0, function* () {
  ...
  ${queryName}(subgraphName: \"${subgraphName}\") {
    ...
    chains {
      ...
      latestBlock {
        ...
        const response = yield (0, node_fetch_1.default)('https://api.thegraph.com/index-node/graphql', {
            headers: {
